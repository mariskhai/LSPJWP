...
{	
    ...
    // update user data
    $result = mysqli_query($conn, "UPDATE kursus SET namakursus='$nama',keterangan='$ket',lama='$lama' WHERE id=$id"); //perhatiin koneksi dan databasenya
    ...
    <div class="container mt-5">
                <form action="" method="post" class="shadow-lg" style="background-color: #f3f4f5; padding: 30px; border-radius: 10px;">
                    ...
                    <div class="mb-3">
                      ...
                      <textarea class="form-control" id="keterangan" name="keterangan" rows="3" required><?php echo $ket;?></textarea>
                    </div>
                    <div class="mb-3">
                      <label for="lama" class="form-label">Lama Kursus</label>
                      <input type="text" name="lama" class="form-control" id="lama" required value=<?php echo $lama;?>> 
                    </div>
