...
<html lang="en">
  ...
  <header>
    ...
    <div class="container mt-5">
      <a class="btn btn-primary"  style="margin-top: 50px; font-weight: bold;"href="tambah_kursus.php" role="button">Tambah</a>
      <div class="row">
        <div class="col-sm text-center">
          <h1 style="margin-top: 5px; font-weight: bold;">Daftar Kursus</span></h1>
  ...
  // Fetch all users data from database
    $result = mysqli_query($conn, "SELECT * FROM kursus ORDER BY id DESC");
    $no=1;
    ...
    <tr>
      ...
      <td><?php echo $user_data['lama'] ?> Jam</td>
      <td><a class="btn btn-primary" href="edit_kursus.php?id=<?php echo $user_data['id'] ?>" role="button"><i class="fa fa-pencil-square" aria-hidden="true"></i></a></td>
      <td><a class="btn btn-danger" href="delete_kursus.php?id=<?php echo $user_data['id'] ?>" role="button"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
    </tr>
    <?php }?>
  </tbody>
</table>
