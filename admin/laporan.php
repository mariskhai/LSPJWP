...
<html lang="en">
    ...
    <div class="container mt-5 pt-5">
      <div class="row">
        <div class="col-sm text-center">
          <h1 style="margin-top: 5px; font-weight: bold;">Laporan Kursus</h1>
  ...
  // Fetch all users data from database
    $result = mysqli_query($conn, "SELECT * FROM daftar ORDER BY id DESC");
    $no=1;
    while($user_data = mysqli_fetch_array($result) ) {
      ?>
    <tr>
      <td><?php echo $no++ ?></td>
      <td><?php echo $user_data['namapeserta'] ?></td>
      <td><?php echo $user_data['dipilih'] ?></td>
      <td><?php echo $user_data['status'] ?></td>
      <td><?php echo $user_data['waktu'] ?></td>
      
      <td><a class="btn btn-success" href="verifikasi.php?id=<?php echo $user_data['id'] ?>" role="button"><i class="fa fa-solid fa-check" aria-hidden="true"></i></a></td>
    </tr>
    <?php }?>
