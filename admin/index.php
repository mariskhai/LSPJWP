...
<html lang="en">
  ...
  <body>
    ...
    <div class="container mt-5">
      <a class="btn btn-primary"  style="margin-top: 50px; font-weight: bold;"href="tambah.php" role="button">Tambah</a>
    

      <div class="row">
        <div class="col-sm text-center">
          <h1 style="margin-top: 5px; font-weight: bold;">Daftar Perserta</span></h1>
  ...
  // Fetch all users data from database
    ...
    <tr>
      ...
      <td><?php echo $user_data['npm'] ?></td>
      <td><?php echo $user_data['kelas'] ?></td>
      <td><?php echo $user_data['status'] ?></td>
      <!-- <td><a class="btn btn-success" href="laporan.php?id=<?php echo $user_data['id'] ?>" role="button"><i class="fa fa-solid fa-check" aria-hidden="true"></i></a></td> -->
      <td><a class="btn btn-primary" href="edit.php?id=<?php echo $user_data['id'] ?>" role="button"><i class="fa fa-pencil-square" aria-hidden="true"></i></a></td>
      <td><a class="btn btn-danger" href="delete.php?id=<?php echo $user_data['id'] ?>" role="button"><i class="fa fa-trash" aria-hidden="true"></i></a></td>
    </tr>
    <?php }?>
  </tbody>
</table>
