...
{	
    ...
    $result = mysqli_query($conn , "INSERT INTO jadwal(namakursus,waktu) VALUES('$nama','$waktu')");
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-sm text-center">
          <h1 style="margin-top: 50px; font-weight: bold;">Edit Jadwal</span></h1>
        </div>
      </div>
    ...
    <div class="container mt-5">
                <form action="" method="post" class="shadow-lg" style="background-color: #f3f4f5; padding: 30px; border-radius: 10px;">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="date" name="waktu" class="form-control" id="kelas" required> 
                    </div>
