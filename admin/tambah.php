...
{	
    ...
    $result = mysqli_query($conn , "INSERT INTO mahasiswa(npm,nama,kelas,password) VALUES('$npm','$nama','$kelas','$password_has')");
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-sm text-center">
          <h1 style="margin-top: 50px; font-weight: bold;">Edit Peserta</span></h1>
        </div>
      </div>
