...
{	
    ...
    // update user data
    $result = mysqli_query($conn, "UPDATE mahasiswa SET nama='$nama',npm='$npm',kelas='$kelas',password='$password_has' WHERE id=$id"); //perhatiin koneksi dan databasenya
...
$result = mysqli_query($conn, "SELECT * FROM mahasiswa WHERE id=$id"); //perhatiin koneksi dan databasenya
    ...
    <div class="container mt-5">
      <div class="row">
        <div class="col-sm text-center">
          <h1 style="margin-top: 50px; font-weight: bold;">Edit <span style="color: #eb3464;">Peserta</span></h1>
        </div>
      </div>
    ...
    <div class="container mt-5">
                <form action="" method="post" class="shadow-lg" style="background-color: #f3f4f5; padding: 30px; border-radius: 10px;">
                    ...
                    <div class="mb-3">
                      ...
                      <input type="text" name="npm" class="form-control" id="npm" required value=<?php echo $npm;?>> 
                    </div>
                    <div class="mb-3">
                      <label for="kelas" class="form-label">Kelas</label>
                      <input type="text" name="kelas" class="form-control" id="kelas" required value=<?php echo $kelas;?>> 
                    </div>
                    <div class="mb-3">
